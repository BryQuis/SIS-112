...
class Tetromino {
    constructor(canvas, cellSize, shapes = [], initPosition = new Position(0, 0), id = 1) {
        this.canvas = canvas;
    ...
    getColorPalette(id) {
        const palette = {
            1: { rigthTriangle: "#B5193B", leftTriangle: "#FFFFFF", square: "#EE1B2E" },
            2: { rigthTriangle: "#FE5E02", leftTriangle: "#FFFFFF", square: "#FE8602" },
            3: { rigthTriangle: "#FE8601", leftTriangle: "#FFFFFF", square: "#FFDB01" },
            4: { rigthTriangle: "#22974C", leftTriangle: "#FFFFFF", square: "#24DC4F" },
            5: { rigthTriangle: "#49BDFF", leftTriangle: "#FFFFFF", square: "#2D97F7" },
            6: { rigthTriangle: "#0000C9", leftTriangle: "#FFFFFF", square: "#0101F0" },
            7: { rigthTriangle: "#8900D3", leftTriangle: "#FFFFFF", square: "#A000F1" }
        };
    
        if (!palette[id]) {
            console.warn(`ID de Tetromino no encontrado: ${id}. Usando color predeterminado.`);
            return palette[1];
        }
        return palette[id];
    }
